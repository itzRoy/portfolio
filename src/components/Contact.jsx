    ...
    return (
        ...
        >
            <motion.div
                ...
                className="flex-[0.75] bg-secondary-dark p-8 rounded-2xl"
            >
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
                    ...
                    <button
                        type="submit"
                        className="bg-secondary py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-tertiary"
                    >
