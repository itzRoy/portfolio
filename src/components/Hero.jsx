...
const Hero = ({ setActive, setIsScrollingIntoView }) => {
    ...
    return (
        <section
            id="#Home"
            className={`relative w-full mx-auto mt-44`}
            ...
            >
                ...
                <div className="W-full flex-1 flex items-center justify-baseleine text-[2rem] lg:text-[3rem]">
                    <div className="w-full">
                        <h1 style={{ animationDelay: '1s' }} className=" animate-slide-bottom opacity-0">
                            Hello, it's Roy
                        </h1>
                        <h2 style={{ animationDelay: '0.6s' }} className="animate-slide-name opacity-0 my-3">
                            And I am
                        </h2>
                        <div style={{ animationDelay: '1s' }} className="animate-slide-top opacity-0  bg-transparent">
                            <Typed
