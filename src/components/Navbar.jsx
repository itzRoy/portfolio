...
const Navbar = ({ activePosition, setActviePosition, setIsScrollingIntoView }) => {
    ...
    useEffect(() => {
        return scrollY.onChange((current) => {
            ...
            if (diff > 0) {
                height.set(Math.max(height.get() - diff * 0.4, initialHeight === 90 ? 55 : 0));
        ...
        >
            ...
            {window.innerWidth > 450 ? (
                <div className="sm:w-1/2 min-w-[60px]">
                    <img className="w-[30px] md:w-[40px] min-w-0" src={logo} alt="logo" />
                </div>
            ) : null}
